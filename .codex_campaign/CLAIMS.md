...
| C-M4-004 | 2026-08-27 | Matching S3 to A2's parameter count closes only 0.4% of the seed-0 Fulltone ESR gap and 25.2% of the Big Muff gap; the preregistered recovery stop rule fails. | VERIFIED_INTERNAL_DEV_NEGATIVE | `experiments/summaries/m4_recovery/metrics.json`; `reports/M4_RECOVERY.md` |
