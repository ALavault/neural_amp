...
| C-M0-003 | 2026-08-27 | The deterministic identity fixture survives a float32 WAV round trip with ESR zero. | PROPOSED | Pending `experiments/summaries/m0_identity/metrics.json` and test output |
